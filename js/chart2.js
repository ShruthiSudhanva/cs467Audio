...
var allData = {"Study":[[{x:1,y:-3,genre:"Jazz",artists:["Chris Botti"].join('\n');},{x:2,y:-6,genre:"Jazz",artists:["Louis Armstrong"]},{x:3,y:-3,genre:"Jazz",artists:["Benny Goodman"]},{x:4,y:-3,genre:"Jazz",artists:["Chris Botti"]},{x:5,y: 0,genre:"Jazz",artists:[""]}],
             ...
             [{x:1,y:-5,genre:"Instrumental",artists:["Vitamin String Quartet"]},{x:2,y:-3,genre:"Instrumental",artists:["2Cellos"]},{x:3,y:-2,genre:"Instrumental",artists:["Vitamin String Quartet"]},{x:4,y:-3,genre:"Instrumental",artists:["2Cellos"]},{x:5,y:0,genre:"Instrumental",artists:[""]}]]
              ,"Workout":[[{x:1,y:-4,genre:"Jazz",artists:["Chris Botti"]},{x:2,y:-8,genre:"Jazz",artists:["Louis Armstrong"]},{x:3,y:-2,genre:"Jazz",artists:["Benny Goodman","Frank Sinatra"]},{x:4,y:-5,genre:"Jazz",artists:["Chris Botti"]},{x:5,y: 0,genre:"Jazz",artists:[""]}],
