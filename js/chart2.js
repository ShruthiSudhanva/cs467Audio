...
var allData = {"Study":[[{x:1,y:-3,genre:"Jazz",artists:["Chris Botti","Louis Armstrong","Thelonious Monk"].join('\n');},{x:2,y:-6,genre:"Jazz",artists:[""]},{x:3,y:-3,genre:"Jazz",artists:["Benny Goodman","Frank Sinatra"]},{x:4,y:-3,genre:"Jazz",artists:["Chris Botti"]},{x:5,y: 0,genre:"Jazz",artists:[""]}],
